...
public class StudentDataBase {
    ...
    public static Supplier<Student> studentSupplier1 = () -> {
        return  new Student(null,2,4.0,"male", Arrays.asList("swimming", "basketball","volleyball"));
    };
    ...
    public static List<Student> getAllStudents(){
        ...
        Student student4 = new Student("Dave",3,5.0,"male", 15,Arrays.asList("swimming", "gymnastics","soccer"));
        /**
         * 4th grade students
         */
        Student student5 = new Student("Sophia",6,3.5,"female",10, Arrays.asList("swimming", "dancing","football"));
        Student student6 = new Student("James",4,8.9,"male", 22,Arrays.asList("swimming", "basketball","baseball","football"));
        Student student7 = new Student("James1",4, 22.9,"male", 22,Arrays.asList("swimming", "basketball","baseball","football"));
